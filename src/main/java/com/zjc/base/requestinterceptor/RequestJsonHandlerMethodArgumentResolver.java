package com.zjc.base.requestinterceptor;
...
public class RequestJsonHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        if ("application/json".equals(servletRequest.getContentType()) || "application/json; charset=utf-8".equals(servletRequest.getContentType()) || "application/json;charset=UTF-8".equals(servletRequest.getContentType())) {
            //如果是json
